...
[all]
control.gordey.local ansible_host=192.168.218.190
node1.gordey.local ansible_host=192.168.218.191
node2.gordey.local ansible_host=192.168.218.192
node3.gordey.local ansible_host=192.168.218.193
db1.gordey.local ansible_host=192.168.218.194
[kube-master]
control.gordey.local
[etcd]
control.gordey.local
[kube-node]
node1.gordey.local
...
cat > /var/named/gordey.local <<EOF
\$TTL 86400
@ IN SOA master.gordey.local. artur.kryukov.biz. (
                                                2021073101 ;Serial
                                                3600 ;Refresh
                                                1800 ;Retry
                                                604800 ;Expire
...
195 IN PTR master.gordey.local.
190     IN      PTR     control.gordey.local.
191     IN      PTR     node1.gordey.local.
192     IN      PTR     node2.gordey.local.
193     IN      PTR     node3.gordey.local.
194     IN      PTR     db.gordey.local.
EOF
